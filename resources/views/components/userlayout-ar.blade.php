      ...
      <div class="col-lg-6 col-md-6">
        <div class="topbar-social text-center text-md-end">
          ...
          <li style="font-weight:600;">
            <a href="{{ url( str_replace('/ar', '', request()->getRequestUri()) ) }}">English</a>
          </li>
          </ul>
        </div>
      </div>
 ...
 <div class="container">
  <div class="row">
    ...
    <ul class="addresss-info">
        <li><i class="fa fa-map-marker"></i> <p>Address: {!! collect(json_decode($contact->addresses, true))
    ->pluck('address')
    ->implode('<br>') !!}
</p> </li>
    ...
    <div class="col-lg-4 col-sm-6">
      ...
      <div class="footer-widget mt-20">
        <div class="row">
          <div class="col-lg-6 col-md-6">
           <p class="mt-15"> &copy;Copyright <span id="copyright"> <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script></span> <a href="#"> Perl Asia </a> All Rights Reserved </p>
          </div>
